...
public class RungeKuttaFunction implements MathFunction{
    ...
    private final double x0; // начальное условие
    private final double y0; // начальное условие


    public RungeKuttaFunction(BiFunction<Double, Double, Double> differentialEquation, double x0, double y0) {
